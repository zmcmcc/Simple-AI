...
local tGroupedDataList = {
	{
		...
		--技能
		['Ability'] = {3,1,2,2,2,6,2,3,3,3,6,1,1,1,6},
		--装备
		['Buy'] = {
			sOutfit,
			"item_bfury",
		...
		--技能
		['Ability'] = { 1, 2, 3, 1, 2, 6, 2, 1, 2, 1, 6, 3, 3, 3, 6 },
		--装备
		['Buy'] = {
			"item_faerie_fire",
			"item_slippers",
		...
		--技能
		['Ability'] = { 2, 1, 3, 1, 1, 6, 1, 2, 2, 2, 6, 3, 3, 3, 6 },
		--装备
		['Buy'] = {
			"item_tango",
			"item_flask",
...
function X.ConsiderWE()
	...
	if abilityEManaCost + abilityWManaCost > bot:GetMana() then return 0,nil,nil; end
...
function X.ConsiderWR()
	...
	if abilityWManaCost + abilityRManaCost > bot:GetMana() then return 0,nil,nil; end
