...
--初始数据
local ability = bot:GetAbilityByName('riki_tricks_of_the_trade')
...
function X.Consider()
	...
	then
		...
		if J.IsValidHero(npcTarget) and J.CanCastOnMagicImmune(npcTarget) and J.IsInRange(npcTarget, bot, nRadius)
		then
			return BOT_ACTION_DESIRE_HIGH;
		end
    end
