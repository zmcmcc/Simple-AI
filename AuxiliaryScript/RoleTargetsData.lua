...
X["allows_hero"] = allowsHeroData--[[{
	...
	["npc_dota_hero_sniper"] = {
		...
		['counter'] = { --针对阵容
            { --发条技师
                ['hero'] = 'npc_dota_hero_rattletrap', --英雄
                ['weight'] = 3, --权重
            },
            { --风暴之灵
                ['hero'] = 'npc_dota_storm_spirit',
                ['weight'] = 3,
            },
            { --裂魂人
                ['hero'] = 'npc_dota_hero_spirit_breaker',
	...
	["npc_dota_hero_medusa"] = {
		...
		['counter'] = { --针对阵容
            { --敌法师
                ['hero'] = 'npc_dota_hero_antimage', --英雄
                ['weight'] = 4, --权重
            },
            { --莱恩
                ['hero'] = 'npc_dota_storm_lion',
                ['weight'] = 3,
            },
            { --莉娜
	...
	["npc_dota_hero_nevermore"] = {
		...
		['proposal'] = { --推荐阵容
            { --马格纳斯
                ['hero'] = 'npc_dota_hero_magnataur', --英雄
                ['weight'] = 3, --权重
            },
            { --复仇之魂
		...
		['counter'] = { --针对阵容
            { --冥界亚龙
                ['hero'] = 'npc_dota_hero_viper', --英雄
                ['weight'] = 3, --权重
            },
            { --痛苦女王
                ['hero'] = 'npc_dota_storm_queenofpain',
                ['weight'] = 3,
            },
            { --风暴之灵
                ['hero'] = 'npc_dota_hero_spirit',
                ['weight'] = 3,
            },
            { --裂魂人
                ['hero'] = 'npc_dota_hero_breaker',
                ['weight'] = 3,
            },
        },
        ['orientation'] = { --英雄定位
	...
	["npc_dota_hero_luna"] = {
		...
		['counter'] = { --针对阵容
            ...
            {
                ['hero'] = 'npc_dota_storm_beastmaster',
                ['weight'] = 3,
            },
            {
	...
	["npc_dota_hero_bloodseeker"] = {
		...
		['counter'] = { --针对阵容
            ...
            {
                ['hero'] = 'npc_dota_hero_storm_abaddon',
                ['weight'] = 3,
            },
            {
	...
	["npc_dota_hero_sven"] = {
        ...
        ['attribute'] = { --英雄属性
            ['type'] = 'Power', --类型 力量：Power 敏捷：Agile 智力：Intelligence
        },
        ['bot'] = true, --电脑可选
	},
    --敌法师
	["npc_dota_hero_antimage"] = {
		...
		['counter'] = { --针对阵容
            ...
            {
                ['hero'] = 'npc_dota_storm_doom_bringer',
                ['weight'] = 3,
            },
            {
                ['hero'] = 'npc_dota_hero_lion',
	...
	["npc_dota_hero_drow_ranger"] = {
		...
		['counter'] = { --针对阵容
            ...
            {
                ['hero'] = 'npc_dota_storm_rattletrap',
                ['weight'] = 3,
            },
            {
                ['hero'] = 'npc_dota_hero_spirit_breaker',
	...
	["npc_dota_hero_phantom_assassin"] = {
		...
		['counter'] = { --针对阵容
            ...
            {
                ['hero'] = 'npc_dota_storm_faceless_void',
                ['weight'] = 3,
            },
            {
                ['hero'] = 'npc_dota_hero_lion',
	...
	["npc_dota_hero_templar_assassin"] = {
		...
		['counter'] = { --针对阵容
            ...
            {
                ['hero'] = 'npc_dota_storm_venomancer',
                ['weight'] = 3,
            },
            {
	...
	["npc_dota_hero_kunkka"] = {
		...
		['counter'] = { --针对阵容
            ...
            {
                ['hero'] = 'npc_dota_hero_storm_juggernaut',
                ['weight'] = 3,
            },
            {
                ['hero'] = 'npc_dota_hero_elder_sven',
                ['weight'] = 3,
            },
            {
                ['hero'] = 'npc_dota_hero_shadow_slardar',
                ['weight'] = 3,
            },
        },
        ['orientation'] = { --英雄定位
	...
	["npc_dota_hero_crystal_maiden"] = {
        ...
        ['attribute'] = { --英雄属性
            ['type'] = 'Intelligence', --类型 力量：Power 敏捷：Agile 智力：Intelligence
        },
        ['bot'] = true, --电脑可选
    },
    --宙斯
